...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(environ.get("11677823"))
    API_HASH = str(environ.get("f1be9e535abfe6f3e75d0acaa6925bc1"))
    BOT_TOKEN = str(environ.get("6543948530:AAEUazkMtXlAIlZKKD_Ohe2BtdHxIwJL7Vg"))
